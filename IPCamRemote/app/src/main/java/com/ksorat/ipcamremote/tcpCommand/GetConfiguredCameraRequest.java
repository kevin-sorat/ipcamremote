...
public class GetConfiguredCameraRequest extends IPCameraTCPCommand {
	private static final String TAG = "IPCamRemote:GetConfiguredCameraRequest";
	private static final String MESSAGE = "Received an exception";

	public GetConfiguredCameraRequest() {
